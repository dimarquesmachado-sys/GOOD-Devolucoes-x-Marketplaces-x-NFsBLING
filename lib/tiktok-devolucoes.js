...
function acharNaLista(lista, codigo, empresa) {
  ...
  // Varias no mesmo pedido: a que VALE e a que nao foi cancelada. Entre
  // elas, a mais recente — e a ponta da cadeia (as antigas tem next_return_id
  // apontando adiante).
  ...
  if (porPedido.length > 1) {
    ...
    escolhida.aviso = 'Este pedido tem ' + porPedido.length + ' solicitacoes; mostrando a que esta valendo.';
  }
  return escolhida;
}
