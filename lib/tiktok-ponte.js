...
async function eventosDevolucoes(empresa, q) {
  ...
  // b182.1 (Codex): falha DE APLICACAO tambem e falha. A rota pode
  // responder HTTP 200 com ok:false (foi o padrao que a gente viu no
  // ultima_coleta), e aceitar isso viraria "zero revelias" silencioso —
  // o mesmo erro que custou uma noite com a Shopee.
  if (r.corpo.ok === false) {
