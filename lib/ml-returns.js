  ...
  function resumoEspreita() {
    ...
    for (const d of Object.values(IDX.mapa)) {
      ...
      if (st === 'delivered') {
        ...
        entreguesLista.push({ marketplace: 'ml', pedido: d.order_id, tracking: d.tracking, dias_desde: dias(d.entregue_em || d.claim_date), entregue_em: d.entregue_em || null, claim_id: d.claim_id, shipment_devolucao: d.shipment_devolucao || null });
        continue;
      }
