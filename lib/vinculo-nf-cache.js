...
function aplicar(itens, empresa) {
  ...
  for (const item of (itens || [])) {
    ...
    if (v) {
      ...
      // b221.2 (Codex): o numero do cache SOBRESCREVE. Ele veio da nota
      // achada pela chave — e a autoridade. O `!item.nf_numero` preservava
      // o capturado errado no refresh seguinte, desfazendo a correcao.
      if (v.numero) item.nf_numero = v.numero;
