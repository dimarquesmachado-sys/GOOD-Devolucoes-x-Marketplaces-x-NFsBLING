...
app.get('/health', (req, res) => {
  res.json({
    ...
    service: 'good-devolucoes-marketplaces-nfsbling',
      ...
      version: '8.0.0 (o modal de lancar defeito virou lib compartilhada, com o prefixo da empresa como parametro — o painel admin ganhou o lancamento sem sair da tela)',
