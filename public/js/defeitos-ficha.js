...
(function () {
  ...
  window.buscarDefeitos = async function () {
    ...
    try {
      ...
      // v4.89 (review do Codex) - o token tambem vale aqui: uma requisicao
  ...
  window.retirarPeca = async function (id) {
    ...
    caixaEdicao('edRetirada', '', async function (txt, aviso) {
      ...
      // v4.89 (review do Codex) - guarda a ficha ALVO antes do await: se o
      ...
      if (!fichaAindaAberta(idAlvo)) return;   // v4.89 - o operador saiu; nao mexe na tela nova
