  ...
  if (itensRender.length > 0) {
    ...
    itensRender.forEach((it, _i) => {
      html += `<div class="item-card" style="display:flex;gap:12px;align-items:flex-start;">
        <div id="fotoitem-${_i}" style="width:88px;height:88px;flex:0 0 auto;border-radius:10px;background:#f2f2f4;border:1px solid #e0e0e0;display:flex;align-items:center;justify-content:center;font-size:30px;">📦</div>
