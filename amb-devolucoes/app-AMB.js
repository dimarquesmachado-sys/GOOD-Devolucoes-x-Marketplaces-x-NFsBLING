...
// b309 - revisao Codex #252 tambem foi so do lado GOOD: la, o defeito de
// estoque manual passou a gravar `tipo: 'problema'` (a tabela da GOOD nunca
// aceitou 'defeito_estoque') e isso quebrou 3 consumidores que ainda
// distinguiam por `tipo`. Aqui na AMB o defeito de estoque grava
// `tipo: 'defeito_estoque'` DIRETO (app-AMB.js:1481) e a tabela dela aceita
// esse valor de verdade - conferido que nao ha nada a espelhar.
const VERSAO = 'AMB Devolucoes b309';
